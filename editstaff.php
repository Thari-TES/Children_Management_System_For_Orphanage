          ...
          <div class="col-md-8">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Staff Update Form</h5>
              </div>
              <div class="card-body">
                <form action="" method="post">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Post</label>
                        <input type="text" class="form-control" name="staff" value="<?php echo $post; ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="update ml-auto mr-auto">
                      <button type="submit" class="btn btn-primary btn-round" name="editStaff">Update Staff</button>
                    </div>
                  </div>
                </form>
              </div>
...
<?php
    if (isset($_POST['editStaff'])) {
     ...
     $password = $_POST['password'];
        ...
        $insert_staff = "update  staff set iname='$name',nic='$nic',contact='$contact' ,post='$post',adrs='$address',username='$username',pw='$password' where staffId = '$edit_id'";
